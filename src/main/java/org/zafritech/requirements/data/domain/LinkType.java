...
@Entity(name = "REQUIREMENTS_LINK_TYPES")
public class LinkType implements Serializable {
   ...
   @Id
    ...
    public String toString() {
        ...
        return "LinkType{" + "id=" + getId() + ", uuId=" + 
                getUuId() + ", linkTypeName=" + getLinkTypeName() + ", linkTypeLongName=" + 
                getLinkTypeLongName() + ", linkTypeDescription=" + 
                getLinkTypeDescription() + ", enabled=" + 
                isEnabled() + ", defaultType=" + isDefaultType() + ", creationDate=" + 
                getCreationDate() + '}';
    }
