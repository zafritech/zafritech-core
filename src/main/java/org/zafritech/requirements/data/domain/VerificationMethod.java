...
@Entity(name = "REQUIREMENTS_VERIFICATION_METHODS")
public class VerificationMethod implements Serializable {
    ...
    public String toString() {
        ...
        return "VerificationMethod{" + "id=" + getId() + ", uuId=" + 
                getUuId() + ", methodCode=" + getMethodCode() + ", methodName=" + 
                getMethodName() + ", methodDescription=" + 
                getMethodDescription() + ", creationDate=" + getCreationDate() + '}';
    }
