...
public class ItemTreeDao {
    ...
    public ItemTreeDao(Long id, Long pId, String name, boolean open, boolean isParent, boolean click) {
    ...
    public ItemTreeDao(Long id, Long pId, String name, boolean open, boolean isParent, boolean click, Long linkId) {
    ...
    public String toString() {
        ...
        return "ItemTreeDao{" + "id=" + getId() + ", pId=" + getpId() + ", name=" + 
